...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8">
                <h2 class="text-dark my-3" style="font-weight: 600;">Admin Users</h2>
            </div>
        ...
        <form action="register.php" method="POST" enctype="multipart/form-data" lass="p-3">
        ...
        <table class="table bg-secondary">
            ...
            <tbody>
                <?php
               require_once('partials/i_users.php');
                ?>
            </tbody>
        </table>
    </div>
