    ...
    <div class="container text-center my-5 d-flex justify-content-center">
        <div class="jumbotron d-flex justify-content-center bg-light rounded" style="width:500px;">
            ...
            <form class="my-5" action="" method="POST" enctype="multipart/form-data" lass="p-3" style="width:400px;">
                ...
                <div class="mb-3">
                    <input type="password" class="form-control w-80 m-auto" name="password" value="<?php echo $row['password']?>">
                </div>
                <div class="mb-3">
                    <input type="password" class="form-control w-80 m-auto" name="cpassword" value="<?php echo $row['password']?>"
                        placeholder="Age" required="required">
                </div>
                <div class="mb-3">
                    <a href="../voters.php" class="btn btn-danger">Cancel</a>
